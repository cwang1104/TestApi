...
type SayHelloClient interface {
	SayHelloToWho(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *sayHelloClient) SayHelloToWho(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/pblogin.SayHello/SayHelloToWho", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SayHelloServer interface {
	SayHelloToWho(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedSayHelloServer) SayHelloToWho(context.Context, *HelloRequest) (*HelloResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHelloToWho not implemented")
}
...
func _SayHello_SayHelloToWho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SayHelloServer).SayHelloToWho(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pblogin.SayHello/SayHelloToWho",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).SayHelloToWho(ctx, req.(*HelloRequest))
	}
...
var SayHello_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pblogin.SayHello",
	HandlerType: (*SayHelloServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHelloToWho",
			Handler:    _SayHello_SayHelloToWho_Handler,
		},
	},
